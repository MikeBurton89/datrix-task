...
const LayoutContent = () => {
  ...
  return (
    <div className="p-4 grid grid-flow-col grid-rows-10/90 w-full h-[100dvh] items-base justify-normal">
      <span className="flex flex-row items-center justify-between w-full p-4">
      ...
      <div className="grid w-full gap-4 lg:grid-flow-row lg:grid-cols-20/80">
        <div className="flex flex-col justify-start w-full gap-4 p-4 overflow-hidden bg-yellow-200">
          <h2 className="text-2xl font-bold">Search your city</h2>
          <CityInput />
          <CityList />
        </div>
        <div className="grid items-stretch justify-center w-full h-full p-4 bg-cyan-200 grid-rows-10/90">
